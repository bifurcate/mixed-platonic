...
def test_cusp_edge_pairing():
  ...
  assert repr(ep) == 'CuspEdgePairing(CuspHalfEdge(Square(0), (2, 3)), CuspHalfEdge(Triangle(0), (1, 3)))'
...
def test_manifold_face_pairing():
  ...
  assert repr(fp) == 'ManifoldFacePairing(ManifoldHalfFace(Octahedron(0), (2, 3, 5)), ManifoldHalfFace(Tetrahedron(0), (2, 0, 3)))'
