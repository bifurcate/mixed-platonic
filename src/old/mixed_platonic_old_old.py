...
def test_embed_octahedron():
  ...
  embed_octahedron(cusp, cellulation_embeddings, cusp_embeddings, octahedron, square, embedding)
...
def test_embed_tetrahedron():
  ...
  embed_tetrahedron(cusp, cellulation_embeddings, cusp_embeddings, tetrahedron, triangle, embedding)
...
def test_infer_embedding_1():
  ...
  inferred_embedding = infer_embedding(cusp_edge_pairing, manifold_face_pairing, embedding)
